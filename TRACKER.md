...
| 仓库 | 本地路径 | 克隆 | 审计 | 审计文档 |
|------|---------|:----:|:----:|---------|
| [`KeygraphHQ/shannon`](https://github.com/KeygraphHQ/shannon) | `repos/agents/shannon` | ✅ | 未开始 |  |
...
| [`0ca/BoxPwnr`](https://github.com/0ca/BoxPwnr) | `repos/agents/BoxPwnr` | ✅ | 未开始 |  |
...
| [`amazon-science/Cyber-Zero`](https://github.com/amazon-science/Cyber-Zero) | `repos/agents/Cyber-Zero` | ✅ | 未开始 |  |
